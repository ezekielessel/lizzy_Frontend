...
const DashBoard: React.FC = () => {
  ...
  const [selectedItem, setSelectedItem] = useState<string>("Download File");
  const sidebarItems: { imageUrl: string; text: string }[] = [
    { imageUrl: download_png, text: "Download File" },

    { imageUrl: email_png, text: "Send Email" },
  ];
      ...
      <header className="flex justify-between items-center bg-white py-5 px-20 shadow-md "style={{backgroundColor:"#5068fb"}}>
        ...
        <div className="flex items-center">
          ...
          <button
            ...
            className="border border-white-500 text-white-500 px-4 py-2 rounded-md" style={{color:"#ffffff"}}
          >
            Sign Out
          </button>
        </div>
